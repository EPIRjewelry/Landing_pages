-- Migration 0002: Client Profiles & Engagement Metrics (Golden Record Pattern)
...
CREATE INDEX IF NOT EXISTS idx_recent_visitors 
ON client_profiles(last_seen) 
WHERE last_seen > (strftime('%s', 'now') - 86400 * 30); -- Active in last 30 days
